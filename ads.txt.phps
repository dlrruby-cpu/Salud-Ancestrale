...
<head>
    ...
    <meta http-equiv="last-modified" content="Mon, 22 Jun 2026 18:58:15 GMT" />
...
<!-- End InMobi Choice. Consent Manager Tag v3.0 (for TCF 2.2) -->
    ...
    <link rel="stylesheet" href="https://es.themoneytizer.com/global/styles/bootstrap.min-5.4.1.css">
                ...
                <link rel="stylesheet" type='text/css' lazyload href="https://es.themoneytizer.com/global/styles/new_global.css?v=5.28">
                    <link rel="stylesheet" type='text/css' lazyload href="https://es.themoneytizer.com/modules/mod_new_manager/styles/login.css?v=5.28">
        
    <meta name="robots" content="index, follow">

        <link rel="canonical" href="https://es.themoneytizer.com/new_manager/login" />
    ...
    <div class="col-12 col-md-6 col-lg-6 d-flex justify-content-center align-items-center login-form-wrapper">
        <div id="page_connexion" class="text-center">
            <div class="container pt-5 pb-5">
                ...
                <form class="row needs-validation col-xxl-6 col-xl-7 col-md-10 col-12 m-auto login-ant-form" novalidate method="POST" action="https://es.themoneytizer.com/new_manager/login">
                    <div class="p-0">
                    ...
                    <div class="mb-4 p-0">
                        <div class=" text-start">
                            <label class="mb-1 text-light text-label" for="password">Contraseña </label>
                    ...
                    <div class="text-center p-0">
                        <button class="col-12" type="submit">Iniciar sesiÓn
</button>
                    </div>
                </form>
            </div>
